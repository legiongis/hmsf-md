...
scout_widget = models.Widget.objects.get(name='scout-widget')

details = {
    'datatype': 'scout-datatype',
    'iconclass': 'fa fa-file-code-o',
    'modulename': 'datatypes.py',
    'classname': 'ScoutDataType',
    'defaultwidget': scout_widget,
    'defaultconfig': None,
...
class ScoutDataType(BaseDataType):
