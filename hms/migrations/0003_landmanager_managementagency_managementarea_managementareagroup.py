            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        blank=True,
                        default=False,
                        help_text="Give this user access to all Archaeological Sites managedby their Agency (as defined above).",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        blank=True,
                        default=False,
                        help_text="Give this user access to all Archaeological Sites within any of the specified areas or groups of areas below.",
                        null=True,
                    ),
                ),
                (
                    "grouped_areas",
                    models.ManyToManyField(blank=True, to="hms.ManagementAreaGroup"),
                ),
                (
                    "individual_areas",
                    models.ManyToManyField(blank=True, to="hms.ManagementArea"),
                ),
                (
                    "management_agency",
                    models.ForeignKey(
